...
CREATE SEQUENCE GLPI_PAU.seq_id_hardwares
  START WITH 1
  INCREMENT BY 1;

-- Création de la sequence pour LOCATIONS
CREATE SEQUENCE GLPI_PAU.seq_id_locations
  START WITH 1
  INCREMENT BY 1;

-- Création de la sequence pour USERS
CREATE SEQUENCE GLPI_PAU.seq_id_users
  START WITH 1
  INCREMENT BY 1;

-- Création de la sequence pour TICKETS
CREATE SEQUENCE GLPI_PAU.seq_id_tickets
  START WITH 1
  INCREMENT BY 1;
  
-- Création de la sequence pour COMMENTS
CREATE SEQUENCE GLPI_PAU.seq_id_comments
  START WITH 1
  INCREMENT BY 1;
  
-- Création de la sequence pour RESSOURCES
CREATE SEQUENCE GLPI_PAU.seq_id_ressources
  START WITH 1
  INCREMENT BY 1;
