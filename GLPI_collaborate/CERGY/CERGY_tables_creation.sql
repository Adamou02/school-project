...
CREATE TABLE GLPI_CERGY.LOCATIONS (
...
CREATE TABLE GLPI_CERGY.HARDWARES (
...
CREATE TABLE GLPI_CERGY.TICKETS (
...
CREATE TABLE GLPI_CERGY.COMMENTS (
    ...
    FOREIGN KEY (fk_answer_to) REFERENCES GLPI_CERGY.COMMENTS(comment_id),  -- Contrainte de clé étrangère
    FOREIGN KEY (fk_ticket) REFERENCES GLPI_CERGY.TICKETS(ticket_id),  -- Contrainte de clé étrangère
    FOREIGN KEY (fk_user) REFERENCES GLPI_CERGY.USERS(user_id)  -- Contrainte de clé étrangère
)
CLUSTER GLPI_CERGY.ticket_cluster(fk_ticket);
...
CREATE TABLE GLPI_CERGY.TICKET_RESSOURCES (
    ...
    FOREIGN KEY (fk_ressource) REFERENCES GLPI_CERGY.RESSOURCES(ressource_id),  -- Contrainte de clé étrangère
    FOREIGN KEY (fk_ticket) REFERENCES GLPI_CERGY.TICKETS(ticket_id)  -- Contrainte de clé étrangère
)
CLUSTER GLPI_CERGY.ticket_cluster(fk_ticket);
